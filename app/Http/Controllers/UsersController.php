...
class UsersController extends Controller
{
     ...
     * The available relationships for current endpoint are: `addresses`, `carts`, `ratings`, `transactions`, `products`.
     * @queryParam sort *string* - No-example
     * Field/attribute to sort the resources in response document by.
     * The available fields for sorting operation in current endpoint are: `id`, `name`, `email`, `phone`, `password`, `remember_token`, `created_at`, `updated_at`, `deleted_at`.
     * @queryParam filter[`filterName`] *string* - No-example
     * Filter the resources by specifying *attribute name* or *query scope name*.
     * The available filters for current endpoint are: `id`, `name`, `email`, `phone`, `password`, `remember_token`, `created_at`, `updated_at`, `deleted_at`.
    ...
    {
        $user = auth()->user()?->id?:0;
        return new UserResource($query->find($user));
    }
